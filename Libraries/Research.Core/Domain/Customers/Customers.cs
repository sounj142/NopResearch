...
namespace Research.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        /// </summary>
        public string PasswordSalt { get; set; } // kiểm tra xem trường này được thiết lập lúc nào, lấy giá trị ở đâu ?
        ...
        /// 1 Customer có thể có 1 hoặc 0 đối tượng Vendor liên kết với nó. Mối quan hệ này là lỏng, khi mà ko có khóa ngoại ràng buộc
        /// Thế vendor rốt cuộc là cái gì ??? 1 người bán lại được phép bán hàng trên site mình ? giống như là 1 cái gian hàng nhỏ ?
        /// </summary>
