...
namespace Research.Core.Domain.Customers
{
    ...
    {
        /// <summary>
        /// Thời gian tồn tại tối thiểu tính theo phút để 1 tài khoản Guest có thể bị xem xét xóa
        /// như thể là tài khoản rác ko còn cần đến nữa
        /// </summary>
        public int? MinLiveMinuteToDeleteGuestCustomer { get; set; }

        /// <summary>
        /// Khoảng thời gian tối thiểu tính theo phút kể từ lần hoạt đông cuối cùng để 1 tài khoản Guest có thể bị xem xét xóa
        /// như thể là tài khoản rác ko còn cần đến nữa
        /// </summary>
        public int? MinLastActivityMinuteToDeleteGuestCustomer { get; set; }
        ...
        /// Qui định rằng những tài khoản Customer bị xóa nên được edit lại để Email và UserName kết thúc bằng hậu tố "-DELETED".
        /// Cách làm này cho phép có thể dùng lại email/user name của tài khoản đã bị xóa để đăng ký tài khoản mới
        /// </summary>
        ...
        /// <summary>
        /// Chiều dài tối đa của Customer.Username 
        /// </summary>
        public int UsernameMaxLength { get; set; }

        /// <summary>
        /// Chiều dài tối đa của Customer.Email 
        /// </summary>
