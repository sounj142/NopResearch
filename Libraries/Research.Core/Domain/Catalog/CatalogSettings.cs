...
namespace Research.Core.Domain.Catalog
{
    public class CatalogSettings: ISettings
    {
        ...
        /// . Mục cấu hình qui định bỏ qua/sử dụng ánh xạ StoreMapping. Nếu trường này bằng true thì ánh xạ store mapping bị bỏ qua, và
        /// dữ liệu mà mỗi Store lấy đc sẽ là tất cả dữ liệu, ko chịu giới hạn nào cả. Ngược lại, dữ liệu mỗi store lấy ra sẽ chịu
        /// ảnh hưởng bởi store mapping nếu có
        /// </summary>
