...
{
    /// <summary>
    /// Miêu tả 1 bài post blog. Nó cài đặt ISlugSupported tức là sẽ hỗ trợ url seo 1 phân đoạn, cài IStoreMappingSupported nghĩa là
    /// mỗi store sẽ có thể hiển thị 1 danh sách blog post khác nhau
    /// </summary>
    public partial class BlogPost : BaseEntity, ISlugSupported, IStoreMappingSupported
    {
        ...
        /// <summary>
        /// Gets or sets the blog comments. 1 bài viết blog có thể có nhiều comment
        /// </summary>
