...
namespace Research.Core.Fakes
{
    public class FakeHttpRequest : HttpRequestBase
    {
        ...
        /// <summary>
        /// relativeUrl: giả lập cho AppRelativeCurrentExecutionFilePath, thường dùng để lấy đường dẫn trong Routing
        /// </summary>
            ...
            HttpCookieCollection cookies, NameValueCollection serverVariables)
        {
            ...
            if (_formParams == null) _formParams = new NameValueCollection();
            if (_queryStringParams == null) _queryStringParams = new NameValueCollection();
            if (_headers == null) _headers = new NameValueCollection();
            if (_serverVariables == null) _serverVariables = new NameValueCollection();
            if (_cookies == null) _cookies = new HttpCookieCollection();
        }
        ...
        // override để cung cấp 1 giá trị hợp lệ
