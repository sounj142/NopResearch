...
{
    public partial class LanguageForCache
    {
        ...
        public static Language Transform(LanguageForCache obj)
        {
            if (obj == null) return null;
            return new Language
            {
                DefaultCurrencyId = obj.DefaultCurrencyId,
                DisplayOrder = obj.DisplayOrder,
                FlagImageFileName = obj.FlagImageFileName,
                Id = obj.Id,
                LanguageCulture = obj.LanguageCulture,
                LimitedToStores = obj.LimitedToStores,
                Name = obj.Name,
                Published = obj.Published,
                Rtl = obj.Rtl,
                UniqueSeoCode = obj.UniqueSeoCode
            };
        }

        public static LanguageForCache Transform(Language obj)
        {
            if (obj == null) return null;
            return new LanguageForCache
            {
                DefaultCurrencyId = obj.DefaultCurrencyId,
                DisplayOrder = obj.DisplayOrder,
                FlagImageFileName = obj.FlagImageFileName,
